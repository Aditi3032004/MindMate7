...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const quizData = [
                {
                    question: "I am confident that I will be a successful student",
                    options: [
                        "Strongly disagree",
                ...
                {
                    question: "I am confident that I will be a successful in my future career",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
                ...
                {
                    question: "I can make academic decisions easily",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
                ...
                {
                    question: "I have enough time to relax after work",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
                ...
                {
                    question: "I think that my worry about examinations is weakness of character",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
                ...
                {
                    question: "The time allocated to classes and academic work is enough.",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
                ...
                {
                    question: "I fear failing courses this year.",
                    options: [
                        "Strongly disagree",
                        "Neither agree or disagree",
                        "Strongly agree",
            ...
            const calculateScore = (answers) => {
                let score = 0;
                const maxScorePerQuestion = 100 / answers.length;
    
                for (let i = 0; i < answers.length; i++) {
                    if (answers[i] === 'Strongly agree') {
                        score += maxScorePerQuestion;
                    } else if (answers[i] === 'Neither agree or disagree') {
                        score += maxScorePerQuestion / 2;
                    } else if (answers[i] === 'Strongly disagree') {
                        score += 0;
                    }
                }
    
                const roundedScore = Math.round(score);
                localStorage.setItem('quizScore', roundedScore);
                return roundedScore;
            };
            ...
            submitBtn.addEventListener("click", () => {
                ...
                if (selectedOptionIndex !== -1) {
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        window.location.href = `acresult.jsp?score=${finalScore}`;
                    }
                } else {
