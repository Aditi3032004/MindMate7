...
<body>
    ...
    <div class="doctor-container">
        <img src="adr1.webp" alt="Dr. Ritesh Sharma">
        <h2>Dr. Ritesh Sharma</h2>
        <p><strong>Specialization:</strong> Student Stress & Exam Anxiety</p>
        <p>Dr. Ritesh Sharma has over 10 years of experience helping students manage academic pressure and exam-related anxiety. He uses cognitive-behavioral therapy (CBT) and personalized stress-relief techniques to improve focus and mental well-being.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="adr2.webp" alt="Dr. Sneha Kapoor">
        <h2>Dr. Sneha Kapoor</h2>
        <p><strong>Specialization:</strong> Study Burnout & Motivation Counseling</p>
        <p>Dr. Sneha Kapoor specializes in helping students overcome burnout, procrastination, and lack of motivation. With 8 years of experience, she combines mindfulness, time management strategies, and therapy to boost academic performance.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="adr3.webp" alt="Dr. Rajeev Menon">
        <h2>Dr. Rajeev Menon</h2>
        <p><strong>Specialization:</strong> Academic Pressure & Performance Anxiety</p>
        <p>Dr. Rajeev Menon has worked with students for 12 years, guiding them through stress caused by high expectations and competition. His holistic approach includes therapy, relaxation techniques, and goal-setting strategies for a balanced academic life.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    </div>
