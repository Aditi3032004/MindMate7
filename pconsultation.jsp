...
<body>
    ...
    <div class="doctor-container">
        <img src="pdr1.webp" alt="Dr. Aditya Verma">
        <h2>Dr. Aditya Verma</h2>
        <p><strong>Specialization:</strong> Personality Development & Confidence Building</p>
        <p>Dr. Aditya Verma has 12 years of experience in helping individuals enhance their confidence, communication skills, and overall personality. His approach includes behavioral therapy, self-awareness techniques, and mindset coaching.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="pdr2.webp" alt="Dr. Sonal Sharma">
        <h2>Dr. Sonal Sharma</h2>
        <p><strong>Specialization:</strong> Emotional Intelligence & Social Skills Training</p>
        <p>Dr. Sonal Sharma specializes in emotional intelligence, self-expression, and social adaptability. With 10 years of experience, she empowers individuals to build meaningful relationships and improve their interpersonal skills.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    <div class="doctor-container">
        <img src="pdr3.webp" alt="Dr. Aditi Rao">
        <h2>Dr. Aditi Rao</h2>
        <p><strong>Specialization:</strong> Behavioral Therapy & Self-Growth Coaching</p>
        <p>Dr. Aditi Rao is an expert in personal development and behavioral therapy. With 8 years of experience, she helps individuals overcome self-doubt, enhance confidence, and build a positive mindset through cognitive restructuring, goal-setting strategies, and self-growth techniques.</p>
        <button onclick="showForm()">Book Consultation</button>
    </div>
    </div>
