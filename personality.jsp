        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const calculateScore = (answers) => {
                for (let i = 0; i < answers.length; i++) {
                    if (answers[i] === 'Strongly agree') {
                        score += 25; // Example: gives 30 points for this answer
                    } else if (answers[i] === 'Neutral') {
                        score += 15; // Example: gives 20 points for this answer
                    } else if (answers[i] === 'Strongly disagree') {
                        score += 10; // Example: gives 10 points for this answer
            ...
            submitBtn.addEventListener("click", () => {
                ...
                if (selectedOptionIndex !== -1) {
                    ...
                    score += selectedAnswer === 'Strongly agree' ? 25 : selectedAnswer === 'Neutral' ? 15 : selectedAnswer === 'Strongly disagree' ? 10 : 0;
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        window.location.href = `presult.jsp?score=${percentage}`; // Redirect to result page with score
                    }
                } else {
